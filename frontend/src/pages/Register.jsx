    ...
    <div className="min-h-screen bg-bg grid-bg flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-md animate-fade-up">
        ...
        <div className="text-center mb-10">
          ...
          <p className="text-dim text-sm mt-2 font-body">Get your unique Customer ID instantly</p>
        </div>
        ...
        <div className="bg-card border border-border rounded-3xl p-8 shadow-card">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label className="block text-xs font-mono text-dim uppercase tracking-widest mb-2">Username</label>
              <input
                type="text"
                name="username"
                value={form.username}
          ...
          <p className="text-center text-dim text-sm font-body mt-6">
            ...
            <Link to="/login" className="text-accent hover:text-glow transition-colors">
              Sign in
            </Link>
          </p>
        </div>

        <div className="mt-4 bg-surface border border-border rounded-2xl p-4 flex items-start gap-3">
          <span className="text-accent text-lg">🔑</span>
          <p className="text-xs text-dim font-body leading-relaxed">
            A unique <span className="text-accent font-mono">6-digit Customer ID</span> will be generated for you automatically upon registration.
          </p>
        </div>
      </div>
    </div>
